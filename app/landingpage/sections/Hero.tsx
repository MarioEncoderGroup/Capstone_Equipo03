export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gray-50">
      {/* Background Banner - Replicando exactamente el original */}
      ...
      {/* Main Hero Content - Replicando diseño exacto */}
      <div 
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start lg:items-center isolation-auto">
          ...
          <div className="space-y-8">
            ...
            {/* CTA Buttons - Completamente aislados */}
          ...
          {/* Right Column - Phone Mockup simplificado */}
          <div className="relative flex justify-center isolate z-10">
            {/* Phone Mockup Container - Hover solo afecta al mockup */}
